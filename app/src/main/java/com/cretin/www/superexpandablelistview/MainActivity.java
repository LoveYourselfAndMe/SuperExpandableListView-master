        ...
        public void handleMessage(Message msg) {
            ...
            if ( msg.what == 1 ) {
                ...
                if (groupPosition == 3) {
                    ...
                    childModels.clear();
                    childModels.add(new ChildModel("测试1" , "[WIFI在线]"));
                    childModels.add(new ChildModel("测试2" , "[WIFI在线]"));
                    childModels.add(new ChildModel("测试3" , "[WIFI在线]"));
                } else {
                    List<ChildModel> childModels = childArray.get(msg.arg1);
                childModels.clear();
